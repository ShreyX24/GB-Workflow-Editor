...
interface ButtonProps {
  btn_color?: "green" | "yellow" | "blue" | "purple" | "red" | "orange";
...
export const Button = ({
  ...
  const bgColors = {
    ...
    orange: "bg-button-orange hover:bg-button-orange-hovered",
  ...
  const textColor =
    btn_color === "blue" || btn_color === "purple" || btn_color === "red" || btn_color === "orange"
      ? "text-foreground"
      : "text-background";
